...
A markdown document saved to `output/prd/` (e.g., `prd-search-redesign.md`, `one-pager-dark-mode.md`). It pulls from your context files and checks for existing specs to avoid contradictions.
