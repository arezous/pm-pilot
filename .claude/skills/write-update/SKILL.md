...
2. Check `output/` and `context/` subfolders (if they exist: `prds/`, `decisions/`, `briefs/`) for recent specs and artifacts related to the project — reference them for status and metrics.
