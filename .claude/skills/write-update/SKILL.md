...
3. Read `template/styles/executive-briefing.md` and apply its format rules — 3 paragraphs max, "what happened / why it matters / what's next" structure, no jargon, metrics as bullet points.
