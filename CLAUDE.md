...
- `context/` contains the project context that grounds all your work. Always read relevant context before generating anything.
...
- `output/` is where generated artifacts go. Save all outputs here with descriptive filenames.
...
3. **Save outputs to `output/`.** Use clear filenames like `prd-search-redesign.md` or `competitive-analysis-2026.md`.
